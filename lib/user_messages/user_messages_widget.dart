...
import 'user_messages_model.dart';
export 'user_messages_model.dart';

class UserMessagesWidget extends StatefulWidget {
  const UserMessagesWidget({Key? key}) : super(key: key);

  @override
  _UserMessagesWidgetState createState() => _UserMessagesWidgetState();
}

class _UserMessagesWidgetState extends State<UserMessagesWidget> {
  late UserMessagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserMessagesModel());
  }
