...
final parametersBuilderMap =
  ...
  'loginOrRegister': ParameterData.none(),
  'createAccount': ParameterData.none(),
  'forgotPassword': ParameterData.none(),
  'editProfile': (data) async => ParameterData(
        allParams: {
          'profilePage': getParameter<String>(data, 'profilePage'),
        },
      ),
  'HomePage': ParameterData.none(),
  'AddPhoneNumber': (data) async => ParameterData(
        allParams: {
          'phoneNumber': getParameter<String>(data, 'phoneNumber'),
        },
      ),
  'AuthSMSCode': ParameterData.none(),
  'SlidePuzzle': ParameterData.none(),
